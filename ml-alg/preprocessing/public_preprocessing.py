...
def public_pipeline(
    ...
    X_train, _ = normalize_data(X_train, mode=config['norm_std'])
    X_val, _ = normalize_data(X_val, mode=config['norm_std'])
    X_test, _ = normalize_data(X_test, mode=config['norm_std'])
